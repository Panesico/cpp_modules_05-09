...
{
	{
		...
		Intern *z = new Intern();
		AForm *b = z->makeForm("SomeRandomForm", "gei");
		b = z->makeForm("PresidentialPardonForm", "gei tu");
	...
	std::cout << "--------------------------------------------------------------------------------------------------------------" << std::endl;
	{
		...
		Intern *z = new Intern();
		AForm *b = z->makeForm("RobotomyRequestForm", "ZA WARUDO");
		AForm *c = z->makeForm("ShrubberyCreationForm", "Pepe");
